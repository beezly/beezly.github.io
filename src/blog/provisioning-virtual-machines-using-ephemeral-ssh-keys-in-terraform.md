...
description: "Improve security when bootstrapping cloud VMs by using Terraform's tls_private_key resource to generate temporary SSH keys that are automatically removed after provisioning"
date: 2018-04-11
